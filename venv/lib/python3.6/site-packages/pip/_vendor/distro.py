...
class cached_property(object):
    ...
    def __get__(self, obj, owner):
        assert obj is not None, 'call {} on an instance'.format(_fname)
        ret = obj.__dict__[_fname] = _f(obj)
        return ret
...
class LinuxDistribution(object):
    ...
    def __init__(self,
        ...
        * :py:exc:`UnicodeError`: A data source has unexpected characters or
        ...
        """
        os_release_file = os_release_file or \
            os.path.join(_UNIXCONFDIR, _OS_RELEASE_BASENAME)
        distro_release_file = distro_release_file or ''  # updated later
        include_lsb = include_lsb
        include_uname = include_uname
    ...
    def __repr__(self):
        ...
        return \
            "LinuxDistribution(" \
            "os_release_file={os_release_file!r}, " \
            "distro_release_file={distro_release_file!r}, " \
            "include_lsb={include_lsb!r}, " \
            "include_uname={include_uname!r}, " \
            "_os_release_info={_os_release_info!r}, " \
            "_lsb_release_info={_lsb_release_info!r}, " \
            "_distro_release_info={_distro_release_info!r}, " \
            "_uname_info={_uname_info!r})".format(
                self=self)
    ...
    def linux_distribution(self, full_distribution_name=True):
        ...
        """
        return (
            name() if full_distribution_name else id(),
            version(),
            codename()
        )
    ...
    def name(self, pretty=False):
        ...
        name = os_release_attr('name') \
            or lsb_release_attr('distributor_id') \
            or distro_release_attr('name') \
            or uname_attr('name')
        if pretty:
            name = os_release_attr('pretty_name') \
                or lsb_release_attr('description')
            if not name:
                name = distro_release_attr('name') \
                       or uname_attr('name')
                version = version(pretty=True)
                if version:
                    name = name + ' ' + version
        return name or ''
        ...
        if best:
            ...
            for v in versions:
                if v != '':
                    version = v
                    break
        if pretty and version and codename():
            version = '{0} ({1})'.format(version, codename())
        return version
    ...
    def like(self):
        ...
        """
        return os_release_attr('id_like') or ''
    ...
    def codename(self):
        ...
        try:
            ...
            return _os_release_info['codename']
        except KeyError:
            return lsb_release_attr('codename') \
                or distro_release_attr('codename') \
                or ''
    ...
    def _os_release_info(self):
        ...
        if os.path.isfile(os_release_file):
            with open(os_release_file) as release_file:
                return _parse_os_release_content(release_file)
        return {}
    ...
    def _lsb_release_info(self):
        ...
        with open(os.devnull, 'w') as devnull:
            try:
                ...
                return {}
        content = _to_str(stdout).splitlines()
        return _parse_lsb_release_content(content)
    ...
    def _uname_info(self):
        with open(os.devnull, 'w') as devnull:
            try:
                ...
                return {}
        content = _to_str(stdout).splitlines()
        return _parse_uname_content(content)
    ...
    def _distro_release_info(self):
        ...
        if distro_release_file:
            ...
            distro_info = _parse_distro_release_file(
                distro_release_file)
            ...
            for basename in basenames:
                ...
                if match:
                    ...
                    distro_info = _parse_distro_release_file(filepath)
                    if 'name' in distro_info:
        ...
        * filepath: Path name of the distro release file.
        ...
        try:
            with open(filepath) as fp:
                ...
                return _parse_distro_release_content(fp.readline())
