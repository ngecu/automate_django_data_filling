...
class VcsInfo(object):
    ...
    def __init__(
        ...
        resolved_revision_type = resolved_revision_type
...
class DirInfo(object):
    ...
    def _to_dict(self):
        # type: () -> Dict[str, Any]
        return _filter_none(editable=editable or None)
...
class DirectUrl(object):
    ...
    def redacted_url(self):
        ...
        netloc = _remove_auth_from_netloc(purl.netloc)
