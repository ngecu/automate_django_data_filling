...
class Resolver(BaseResolver):
    ...
    def __init__(
        ...
        _result = None  # type: Optional[Result]
    ...
    def resolve(self, root_reqs, check_supported_wheels):
        ...
        for req in root_reqs:
            if req.constraint:
                ...
                r = factory.make_requirement_from_install_req(
        ...
        try:
            ...
            error = factory.get_installation_error(e)
            six.raise_from(error, e)

        req_set = RequirementSet(check_supported_wheels=check_supported_wheels)
        for candidate in _result.mapping.values():
            ...
            installed_dist = factory.get_dist_to_uninstall(candidate)
            if installed_dist is None:
                # There is no existing installation -- nothing to uninstall.
                ireq.should_reinstall = False
            elif factory.force_reinstall:
        ...
        factory.preparer.prepare_linked_requirements_more(reqs)
        return req_set
    ...
    def get_installation_order(self, req_set):
        ...
        """
        assert _result is not None, "must call resolve() first"

        graph = _result.graph
        weights = get_topological_weights(
            graph,
            expected_node_count=len(_result.mapping) + 1,
        )
