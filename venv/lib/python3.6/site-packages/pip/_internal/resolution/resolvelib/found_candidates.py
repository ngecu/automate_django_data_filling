...
class FoundCandidates(collections_abc.Sequence):
    ...
    def __init__(
        ...
        _get_others = get_others
        _installed = installed
        _prefers_installed = prefers_installed
    ...
    def __iter__(self):
        ...
        if not _installed:
            candidates = _get_others()
        elif _prefers_installed:
            candidates = itertools.chain([_installed], _get_others())
        else:
            candidates = _insert_installed(_installed, _get_others())
    ...
    def __bool__(self):
        # type: () -> bool
        if _prefers_installed and _installed:
            return True
        return any(self)
