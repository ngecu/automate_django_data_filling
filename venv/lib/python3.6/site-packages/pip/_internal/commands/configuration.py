...
class ConfigurationCommand(Command):
    ...
    def get_name(self, options, args):
        # type: (Values, List[str]) -> None
        key = _get_n_args(args, "get [name]", n=1)
    ...
    def set_name_value(self, options, args):
        # type: (Values, List[str]) -> None
        key, value = _get_n_args(args, "set [name] [value]", n=2)
    ...
    def unset_name(self, options, args):
        # type: (Values, List[str]) -> None
        key = _get_n_args(args, "unset [name]", n=1)
        configuration.unset_value(key)
    ...
    def list_config_values(self, options, args):
        ...
        _get_n_args(args, "debug", n=0)

        print_env_var_values()
        # Iterate over config files and print if they exist, and the
        # key-value pairs present in them if they do
        for variant, files in sorted(configuration.iter_config_files()):
    ...
    def print_env_var_values(self):
        ...
        with indent_log():
            for key, value in sorted(configuration.get_environ_vars()):
    ...
    def open_in_editor(self, options, args):
        ...
        fname = configuration.get_file_to_edit()
        if fname is None:
