...
class CacheCommand(Command):
    ...
    def run(self, options, args):
        ...
        handlers = {
            "dir": get_cache_dir,
            "info": get_cache_info,
            "list": list_cache_items,
            "remove": remove_cache_items,
            "purge": purge_cache,
        }
    ...
    def get_cache_info(self, options, args):
        ...
        num_http_files = len(_find_http_files(options))
        num_packages = len(_find_wheels(options, '*'))

        http_cache_location = _cache_dir(options, 'http')
        wheels_cache_location = _cache_dir(options, 'wheels')
    ...
    def list_cache_items(self, options, args):
        ...
        files = _find_wheels(options, pattern)
    ...
    def remove_cache_items(self, options, args):
        ...
        files = _find_wheels(options, args[0])

        # Only fetch http files if no specific pattern given
        if args[0] == '*':
            files += _find_http_files(options)
    ...
    def purge_cache(self, options, args):
        ...
        return remove_cache_items(options, ['*'])
    ...
    def _find_http_files(self, options):
        ...
        http_dir = _cache_dir(options, 'http')
        return filesystem.find_files(http_dir, '*')

    def _find_wheels(self, options, pattern):
        # type: (Values, str) -> List[str]
        wheel_dir = _cache_dir(options, 'wheels')
