...
class InstallCommand(RequirementCommand):
    ...
    def run(self, options, args):
        ...
        req_tracker = enter_context(get_requirement_tracker())
        ...
        try:
            reqs = get_requirements(args, options, finder, session)

            reject_location_related_install_options(
                reqs, options.install_options
            )

            preparer = make_requirement_preparer(
            ...
            if should_warn_about_conflicts:
                conflicts = _determine_conflicts(to_install)
            ...
            if conflicts is not None:
                _warn_about_conflicts(
                    conflicts,
                    resolver_variant=determine_resolver_variant(options),
                )
