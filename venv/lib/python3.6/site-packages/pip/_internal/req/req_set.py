...
class RequirementSet(object):
    ...
    def __init__(self, check_supported_wheels=True):
        ...
        requirements = OrderedDict()  # type: Dict[str, InstallRequirement]  # noqa: E501
        check_supported_wheels = check_supported_wheels

        unnamed_requirements = []  # type: List[InstallRequirement]

    def __str__(self):
        # type: () -> str
        requirements = sorted(
            (req for req in requirements.values() if not req.comes_from),
    ...
    def add_unnamed_requirement(self, install_req):
        ...
        unnamed_requirements.append(install_req)
    ...
    def add_named_requirement(self, install_req):
        ...
        requirements[project_name] = install_req
    ...
    def add_requirement(
        ...
        if install_req.link and install_req.link.is_wheel:
            ...
            if (check_supported_wheels and not wheel.supported(tags)):
    ...
    def has_requirement(self, name):
        ...
        return (
            project_name in requirements and
            not requirements[project_name].constraint
        )
    ...
    def all_requirements(self):
        ...
        return unnamed_requirements + list(requirements.values())
