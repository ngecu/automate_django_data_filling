...
class RequirementsFileParser(object):
    ...
    def _parse_and_recurse(self, filename, constraint):
        ...
        for line in _parse_file(filename, constraint):
            if (
                ...
                for inner_line in _parse_and_recurse(
    ...
    def _parse_file(self, filename, constraint):
        # type: (str, bool) -> Iterator[ParsedLine]
        _, content = get_file_content(filename, _session)

        lines_enum = preprocess(content)

        for line_number, line in lines_enum:
            try:
                args_str, opts = _line_parser(line)
