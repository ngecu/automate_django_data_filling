...
class CacheablePageContent(object):
    ...
    def __eq__(self, other):
        ...
        return (isinstance(other, type(self)) and
                page.url == other.page.url)

    def __hash__(self):
        # type: () -> int
        return hash(page.url)
...
class LinkCollector(object):
    ...
    def find_links(self):
        # type: () -> List[str]
        return search_scope.find_links
    ...
    def fetch_page(self, location):
        ...
        """
        return _get_html_page(location, session=session)
    ...
    def collect_links(self, project_name):
        ...
        find_link_links = [Link(url, '-f') for url in find_links]
        ...
        url_locations = [
            ...
            if session.is_secure_origin(link)
        ]
