...
class SessionCommandMixin(CommandContextMixIn):
    ...
    def __init__(self):
        ...
        _session = None  # Optional[PipSession]
    ...
    def get_default_session(self, options):
        ...
        if _session is None:
            _session = enter_context(_build_session(options))
            # there's no type annotation on requests.Session, so it's
            # automatically ContextManager[Any] and _session becomes Any,
    ...
    def _build_session(self, options, retries=None, timeout=None):
        ...
        session = PipSession(
            ...
            index_urls=_get_index_urls(options),
        )
...
def with_cleanup(func):
    ...
    def wrapper(self, options, args):
        ...
        assert tempdir_registry is not None
        if options.no_clean:
            configure_tempdir_registry(tempdir_registry)
