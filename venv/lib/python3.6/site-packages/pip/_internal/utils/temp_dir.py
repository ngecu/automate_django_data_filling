...
class TempDirectoryTypeRegistry(object):
    ...
    def __init__(self):
        # type: () -> None
        _should_delete = {}  # type: Dict[str, bool]
    ...
    def get_delete(self, kind):
        ...
        default True.
        """
        return _should_delete.get(kind, True)
...
class TempDirectory(object):
    ...
    def path(self):
        # type: () -> str
        assert not _deleted, (
            "Attempted to access deleted path: {}".format(_path)
        )
        return _path

    def __repr__(self):
        # type: () -> str
        return "<{} {!r}>".format(__class__.__name__, path)
    ...
    def _create(self, kind):
        # type: (str) -> str
        """Create a temporary directory and store its path in path
        """
...
class AdjacentTempDirectory(TempDirectory):
    ...
    def _create(self, kind):
        # type: (str) -> str
        root, name = os.path.split(original)
        for candidate in _generate_names(name):
