...
class IndentingFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        message_start = get_message_start(formatted, record.levelno)
        formatted = message_start + formatted

        prefix = ''
        if add_timestamp:
            # TODO: Use Formatter.default_time_format after dropping PY2.
            t = formatTime(record, "%Y-%m-%dT%H:%M:%S")
...
class ColorizedStreamHandler(logging.StreamHandler):
    ...
    def _using_stdout(self):
        ...
        """
        if WINDOWS and colorama:
            # Then stream is an AnsiToWin32 object.
    ...
    def handleError(self, record):
        ...
        if (exc_class and _using_stdout() and
...
class BetterRotatingFileHandler(logging.handlers.RotatingFileHandler):
    ...
    def _open(self):
        ensure_dir(os.path.dirname(baseFilename))
