...
class Subversion(VersionControl):
    ...
    def get_vcs_version(self):
        ...
        :raises: BadCommand: If ``svn`` is not installed.
        """
        if _vcs_version is not None:
            # Use cached version, if available.
            # If parsing the version failed previously (empty tuple),
            # do not attempt to parse it again.
            return _vcs_version

        vcs_version = call_vcs_version()
        _vcs_version = vcs_version
        return vcs_version
    ...
    def export(self, location, url):
        ...
        with indent_log():
            ...
            cmd_args = make_command(
                'export', get_remote_call_options(),
    ...
    def fetch_new(self, dest, url, rev_options):
        ...
        cmd_args = make_command(
            'checkout', '-q', get_remote_call_options(),
    ...
    def switch(self, dest, url, rev_options):
        # type: (str, HiddenText, RevOptions) -> None
        cmd_args = make_command(
            'switch', get_remote_call_options(), rev_options.to_args(),
            url, dest,
        )
        run_command(cmd_args)
    ...
    def update(self, dest, url, rev_options):
        # type: (str, HiddenText, RevOptions) -> None
        cmd_args = make_command(
            'update', get_remote_call_options(), rev_options.to_args(),
            dest,
        )
        run_command(cmd_args)
